...
<body>
    <div id="wrapper">
        ...
        <div id="navigation">
           <a href="#" class="menu-togglr"><i class="fa fa-bars"></i></a>
            <ul>
                ...
                <li><a href="Controler/CarteMère.ctrl.php">Carte mère</a></li>
        ...
        <div class="container">
            ...
            <!---first box--->
            <a href="Controler/DisqueDur.ctrl.php">
                <div class="box">
            ...
            <!---second box--->
            <a href="Controler/CarteMère.ctrl.php">
                <div class="box">
            ...
            <!---third box--->
            <a href="Controler/Souris.ctrl.php">
                <div class="box">
            ...
            <!---fourth box--->
            <a href="Controler/Processeur.ctrl.php">
                <div class="box">
